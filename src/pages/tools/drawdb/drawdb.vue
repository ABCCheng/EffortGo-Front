...
<template>
    <div ref="fullscreenElementRef" class="drawdb-container" :class="{ fullscreen: isFullscreen }" :style="{ height: isSmallScreen ? 'calc(var(--vheight) - 120px)' : 'calc(var(--vheight) - 130px)' }">
        ...
        <iframe src="/local-drawdb/index.html" width="100%" height="100%" frameborder="0"></iframe>
    </div>
</template>
