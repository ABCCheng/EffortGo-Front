...
<template>
  <div flex items-center justify-center gap-2>
    <c-tooltip :tooltip="$t('home.nav.github')" position="bottom">
      <n-button data-track-label="Button_FooterGithub" circle variant="text" tag="a" class="theme-button" href="https://github.com/ABCCheng/effortgo-front"
    ...
    <c-tooltip :tooltip="$t('home.nav.twitterX')" position="bottom">
      <n-button data-track-label="Button_FooterX" circle variant="text" tag="a" class="theme-button" href="https://x.com/EffortGo2024" rel="noopener"
        target="_blank">
        <n-icon size="25" :component="IconBrandX" />
      </n-button>
    </c-tooltip>

    <c-tooltip :tooltip="$t('home.nav.xiaohongshu')" position="bottom">
      <n-button data-track-label="Button_FooterXiaohongshu" circle variant="text" tag="a" class="theme-button"
    ...
    <c-tooltip :tooltip="$t('home.nav.about')" position="bottom">
      <n-button data-track-label="Button_FooterAbout" circle variant="text" tag="a" class="theme-button" @click="goToAbout">
